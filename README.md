...
若想直接使用本数据集训练的模型参数，可直接下载模型文件[rank-bert](https://pan.baidu.com/s/1WiNlD4LRUijGD88gzQukHg)，密码:urw9。并将下载的所有文件（非文件夹）放在目录`file/supervise/bert/`下。
...
若想直接使用本数据集训练的模型参数，可直接下载模型文件[simcse-bert](https://pan.baidu.com/s/1DJMoa6LRbg7OFnzM08VKFA)，密码:1rxs。并将下载的所有文件（非文件夹）放在目录`file/unsupervise/simcse_bert/`下。
